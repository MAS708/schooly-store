        ...
        <div class="container-fluid mt-3 ml-4 ml-4 ">
            <nav class="nav-menu d-none d-lg-block">
                        ...
                        <div class="menu d-none d-lg-block mt-2 mr-4">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownakun">
                                    <div class="menu mt-2" style="cursor:pointer"><i class="fas fa-sign-in-alt ml-3 mr-2"></i>Login </div>
                                    <div class="menu mt-2" style="cursor:pointer"><i class="fas fa-user-plus ml-3 mr-2"></i>Register</div>
                                    <div class="menu mt-2" style="cursor:pointer"><i class="fas fa-sign-out-alt ml-3 mr-2"></i>Logout</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="user d-lg-none text-center mt-5">
                    <a href="index.html"><img src="assets/img/team/team-1.jpg" alt="" class="img-fluid box-user2"></a>
                </div>
                <div class="biodata d-lg-none text-center mt-2">
                    <h3><b>Adam Alex</b></h3>
                    <p>XII SIJA</p>
                    <div class="row d-flex justify-content-center mt-4 ">
                        <div class="menu" style="cursor:pointer"><i class="fas fa-sign-in-alt ml-3 mr-2"></i>Login </div>
                        <div class="menu" style="cursor:pointer"><i class="fas fa-user-plus ml-3 mr-2" ></i>Register</div>
                        <div class="menu" style="cursor:pointer"><i class="fas fa-sign-out-alt mr-2"></i>Logout</div>
                    </div>
                </div>
                ...
                <div class="menu d-lg-none ml-2 ">
                    <a href="#ProdukTerbaru"><i class="fa fa-angle-right mr-2"></i>Home</a>
                </div>
                <div class="menu d-lg-none ml-2 ">
