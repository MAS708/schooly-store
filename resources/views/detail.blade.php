                                    ...
                                    <div class="detail-produk d-flex flex-column ml-2">
                                        <div class="box-text-display-detail-index">
                                            ...
                                            <div class="deskripsi d-none d-md-block ">
                                                ...
                                                <div class="text-display text-justify text-secondary mt-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vitae ac at nunc faucibus. Erat nisi, risus integer cras augue ultrices pretium mattis integer. Massa dis dolor purus suspendisse sociis adipiscing morbi eget sed.</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="box-items ">
                                        <div class="box-items-price-top ">
                                            <div class="d-flex justify-content-end">
                                                <div class="text-items-price-top border border-dark">K</div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="box-footer">
                                            <div class="card-footer bg-white border-0">
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="text-items-barang text-secondary text-left d-flex justify-content-start"></div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="text-items-price-bottom d-flex justify-content-start">K</div>
                                                    </div>
                                                    <div class="col">
            ...
            <div class="row mt-4">
                <div class="col-xl-12">
                    <div class="box-text-display-button d-flex justify-content-center">
                        <a href="">
                            <div class="text-display-button text-center">Lihat Semua Yang Lagi Hangat</div>
                         </a>
                    </div>
                </div>
            </div>
