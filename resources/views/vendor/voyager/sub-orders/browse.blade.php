                                ...
                                <tr>
                                    ...
                                    <td class="no-sort no-click bread-actions">
                                        ...
                                        @if($data->status == 'pending')
                                            <a  href=" {{route('order.canceled', $data)}} "
                                                class="btn btn-sm btn-danger pull-right">
                                                <i class="{{ $action->getIcon() }}"></i> <span class="hidden-xs hidden-sm">Decline</span>
                                            </a>
                                            <a  href=" {{route('order.delivered', $data)}} "
                                                class="btn btn-sm btn-primary pull-right">
                                                <i class="{{ $action->getIcon() }}"></i> <span class="hidden-xs hidden-sm">Deliver</span>
                                            </a>
                                        @endif
                                    </td>
                                </tr>
